...
$(document).ready(function () {
  function showdata1() {
    ...
    var s = 1;
    $.ajax({
      url: "b_s/sale-retrieve_search.php?search=",
      method: "GET",
      dataType: "json",
    ...
    success: function (data) {
      ...
      $("#utr").val(data.utr);
        ...
        $("#search").on("keyup", function () {
          ...
          var s = 1;
          $.ajax({
            url: "b_s/sale-retrieve_search.php?search=" + search_term,
            type: "GET",
            success: function (data) {
